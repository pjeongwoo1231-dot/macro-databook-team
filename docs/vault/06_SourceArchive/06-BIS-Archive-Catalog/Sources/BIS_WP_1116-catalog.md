---
title: "BIS WP 1116 — Absolute blockchain strength? Evidence from the ABS market in China"
type: primary_source
institution: "Bank for International Settlements"
series: "BIS Working Papers"
number: 1116
published: "August 2023"
authors: "Jing Liu , Ilhyock Shim and Yanfeng Zheng"
source_kind: "working-paper"
peer_reviewed: false
primary_text_available: true
fulltext_verified: true
pages: 31
text_characters: 73883
sha256: "17b560b8b44354887cafe901ed6e745fd5a0f66fce907e4149985213fc7e9642"
catalog_filename: "BIS_WP_1116-catalog.md"
...
# BIS WP 1116 — Absolute blockchain strength? Evidence from the ABS market in China

> 이 파일은 공식 PDF 전문을 로컬 아카이브에 확보하고, 재현 가능한 키워드 규칙으로 색인한 **원문 카탈로그 노트**입니다. 분석적 요약 노트가 아니며, 저자의 주장·방법·한계를 인용하려면 원문 전문을 직접 확인해야 합니다.

| 항목 | 내용 |
|---|---|
| 저자 | Jing Liu , Ilhyock Shim and Yanfeng Zheng |
| 발행 | August 2023 |
| 공식 PDF | [전문](https://www.bis.org/publ/work1116.pdf) |
| 공식 랜딩페이지 | [페이지](https://www.bis.org/publ/work1116.htm) |
| 검증 | PDF 서명·페이지 수·텍스트 추출·SHA-256 확인 |
| 페이지·텍스트 | 31쪽 · 73,883자 |
| 자동 주제색인 | macro-modelling-forecasting-and-data, credit-asset-prices-and-real-estate, digital-finance-payments-and-cbdc |
| 일치 점수 | macro-modelling-forecasting-and-data: 19, credit-asset-prices-and-real-estate: 17, digital-finance-payments-and-cbdc: 13 |
...
[1]: https://www.bis.org/publ/work1116.pdf "BIS Working Paper 1116: Absolute blockchain strength? Evidence from the ABS market in China"
