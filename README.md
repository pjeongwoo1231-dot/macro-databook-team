...
`docs/vault/` — 연구 노트 **1,197개**(제텔 188 · 논문 450 · 문헌 399 · 지표 노드 52 · MOC 33).
Obsidian Sync가 본선이고 이건 사본이다. 초대를 아직 못 받았거나 Obsidian을 안 써도 읽을 수 있다.

먼저 읽을 것: `docs/vault/03_MOC/시황 분석 진입점.md` · `좋은 시황의 규칙.md`

⚠ **PDF 210개(261MB)와 `06_SourceArchive/`는 뺐다** — 저작권과 저자 이메일 때문이다.
